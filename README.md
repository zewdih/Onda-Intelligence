...
## What It Does
- Detects shoreline plastic via computer vision
- Estimates waste volume and weight
- Projects cleanup time and crew size
- Accounts for mission blockers (reef access, terrain, vessel limits)
- Optimizes ship capacity planning
